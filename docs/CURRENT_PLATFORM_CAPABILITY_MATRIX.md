...
| Tools / Production Data Import | No operational route | Ownership, target architecture and approved collection plan only | Task 238 selects the Production-governed domain; Task 239 classifies Formula and Method/WI targets; Task 240 specifies package fields, provenance, review, readiness and waves | No upload, parser, staging, review UI, apply, bucket, permission or Migration 056 exists; Tasks 241-243 remain future |
