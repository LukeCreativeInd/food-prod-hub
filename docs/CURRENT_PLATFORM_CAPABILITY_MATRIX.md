...
| Tenant Admin / Commerce Integrations | `/integrations` | Static catalogue plus unapplied schema foundation | Migration 046 defines provider-neutral connections, authority, source projections and sync evidence | No live connection, provider runtime, mutation action, mapping or Production Demand; Task 233 next after apply/validation |
...
| Production / Demand intake | None | Source schema drafted; demand missing | Migration 046 preserves connection/order/line attribution; legacy Shopify/Zapiet/CSV flow remains external | Migration unapplied; no runtime, mapping, contribution, demand, freeze or plan linkage |
| Commerce / Shopify connector | None | Provider-neutral schema drafted; connector not operational | Public reviewed distribution and security architecture approved; migration 046 supplies empty provider-neutral persistence | No app registration, listing, review, credential, webhook, connection, source order or protected customer data exists; Task 233 remains implementation |
