...
| Tenant Admin / Commerce mappings | `/integrations/shopify/mappings` | Repository implementation; migration pending | Task 234 adds direct, bundle/pack and exclusion mapping review, approval history and source-line interpretation readiness | Migration 049 is unapplied; zero connection/catalogue/mapping rows; no demand contribution or Production Demand creation |
