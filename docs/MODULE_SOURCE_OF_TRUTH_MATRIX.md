...
| Formulas and versions | Products: `formula_versions`, `formula_lines` | Costings and Production | Versioned; active/published meaning must preserve history | Formula/BOM is not a production method or execution record | Operational foundation |
...
| Production demand | Future Production planning domain | Inventory requirements and execution | Live, reviewed/frozen and post-freeze delta states must differ | Future facility/date scope | Critical future architecture |
