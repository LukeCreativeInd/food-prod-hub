...
| 202 UOM Conversion Foundation Plan | Plan tenant/supplier/item conversions. | Blocks costing, receiving and production accuracy. | Products, Costings, Inventory, Production | No direct admin UI | Troubleshooting impact | Links supplier units to internal units | Plan doc | Docs | High |
| 203 UOM Conversion Schema Foundation | Add conversion tables and RLS. | Enables reviewed conversion storage. | Products, Costings, Inventory | Possible admin future controls | Document new checks | Used by posting/costing/planning | SQL migration | Migration | High |
