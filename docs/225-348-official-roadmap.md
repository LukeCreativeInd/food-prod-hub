...
Task 228 is the latest completed task after the current changeset is committed. Task 224 is committed at `8b8e94a87f6e94fef78c05317f87cad4bb01caea`; Task 225 is committed at `82a81613556c311198449670b0425106f062a4ef`; Task 226 is committed at `36d53894579e0e8762d7ed441187e5c23552678e`; Task 227 is committed at `fa59c928f8f94a2c320f53144c36d632a140e74c`. Task 228's exact hash must be backfilled by Task 229. Task 229 is the next approved task. No migration is pending.
...
| 228 | External Order Intake and Production Demand Architecture | **Complete in durable post-commit wording.** Defines provider-neutral source observations/orders/lines, versioned interpretation/contributions, live/reviewed/frozen demand, deltas, adjustments and source-to-plan traceability. Exact hash is backfilled by Task 229. | Planning/architecture | No | Defines replacement for CSV aggregation and mutable demand. |
