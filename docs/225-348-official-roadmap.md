...
Task 237 is production accepted at `13a5f1b4aca93f0f2fbb38dd256ec5968044ef67` and deployment `dpl_B7GLzEp5a65YArgHfJRdmciJ2rhy`. Task 238 is complete and committed at `e23024761f1197997b100a4e26cd401c0f19330a`. Task 239 is complete and committed at `cf2a495786a6efd9cf87372496fcfc71ec766fec`. Task 240 is documentation-complete and uncommitted pending Luke review; Task 241 follows only after Task 240 review and commit. Architecture Gate 1 remains approved and Demand Gate 2 is satisfied for this sequencing step. Migration 045 is live/browser validated but unregistered; Migrations 046-055 are live/registered. Migration 056 does not exist. Controlled Shopify development-store validation, Stock On Hand and marketing DNS remain separate.
...
| 240 | Approved Production Data Collection and Import Plan | **Documentation complete and uncommitted pending review.** Defines one controlled Clean Eats collection package, stable keys, provenance, responsibility, validation/readiness, waves and apply/reconciliation direction; depends on 238-239. | Planning/data architecture | No | Creates safe path away from legacy constants; Task 241 remains blocked until commit. |
