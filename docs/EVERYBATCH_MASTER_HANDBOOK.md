...
Read next: `CHAT_HANDOVER_CURRENT.md`, `EVERYBATCH_ROLLING_ROADMAP.md`, `EVERYBATCH_INFORMATION_ARCHITECTURE.md`, `EVERYBATCH_UX_DESIGN_SYSTEM.md`, `EVERYBATCH_PAGE_PATTERN_SYSTEM.md`, `EVERYBATCH_CROSS_MODULE_NAVIGATION_MODEL.md`, `REVIEW_REGISTER.md`, `EVERYBATCH_CANDIDATE_BACKLOG.md`, `CODEX_TASK_STANDARDS.md`, `EVERYBATCH_ENGINEERING_OPERATIONS.md`, both current matrices, `DECISION_LOG.md`, `TASK_INDEX.md`, then the current task document.
