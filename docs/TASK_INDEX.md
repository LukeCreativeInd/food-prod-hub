...
| 226 | Facility And Site Architecture Decision | **Complete.** Suggested commit title: `Decide facility architecture`. Exact commit hash: **To be backfilled by Task 227 through the post-commit context-delta workflow.** | None | Selects organisation-owned facilities, selective direct operational-root ownership, stable derivation, single-facility default UX and the gated Task 231 blueprint. |
| 227 | Commerce Connections And Contract Manufacturing Architecture | **Next approved task** | None expected | Must preserve the Task 226 facility/tenant boundary; Architecture Gate 1 follows Task 230. |
| 228-348 | Official approved roadmap direction | **Approved sequencing, not implemented by Task 226** | Per task | See `225-348-official-roadmap.md`; later changes require explicit Luke approval. |
...
| 226 | Facility And Site Architecture Decision | Complete; suggested commit `Decide facility architecture`; exact hash to be backfilled by Task 227 | [`226-facility-site-architecture-decision.md`](./226-facility-site-architecture-decision.md) | Selects organisation-owned facilities, direct operational roots, parent derivation, single-facility default UX and the gated Task 231 strategy without schema. |
