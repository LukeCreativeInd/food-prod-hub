...
The active sequence is [EveryBatch Official Roadmap - Tasks 225-348](./225-348-official-roadmap.md). Task 234 is the latest completed repository task; its exact commit hash must be backfilled by Task 235. Review Gate 0 is closed and Architecture Gate 1 is approved. Migration `045_facility_schema_foundation.sql` is live and browser validated but unregistered; Migrations 046-048 are live/registered. Task 233 and its production hotfix (`ebe3330514a160cd1820bd35ed804abd85d4e316`, `ad501246ed2c762341ce6e550fa1cbbbc58a6549`) are deployed and browser accepted without any Shopify store connection. Task 234 adds tenant-safe catalogue mapping schema and UI through drafted, unapplied Migration 049; no connection, catalogue, mapping, Production Demand or seed data exists. Task 235 follows only after Task 234 review and Migration 049 application/verification. Earlier roadmap files are preserved as superseded historical planning.
