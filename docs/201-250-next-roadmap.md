...
| 209 Stock On Hand Summary UI v1 | Show stock by item/location/lot/unit using direct aggregation first. | Core inventory visibility. | Inventory | Tenant health later | Guide/release note | Feeds production planning; flags mixed units until UOM rules are integrated | UI/data/docs | UI | High |
