...
const exactPageTitles: Record<string, PageTitleMeta> = {
  ...
  "/qa/receiving/new": { title: "New Receiving Check", context: "QA" },
  ...
  "/qa/holds/new": { title: "New QA Hold", context: "QA" },
...
const dynamicPageTitles: Array<{
  ...
  {
    pattern: /^\/qa\/receiving\/[^/]+$/,
    meta: { title: "Receiving Check Detail", context: "QA" },
  },
  {
    pattern: /^\/qa\/holds\/[^/]+$/,
    meta: { title: "QA Hold Detail", context: "QA" },
  },
];
