...
This is a navigation index, not a replacement for task documents. Titles/status are based on repository documents and Git history. Task 228 is the latest completed task after the current changeset is committed. Task 226 is committed at `36d53894579e0e8762d7ed441187e5c23552678e`; Task 227 is committed at `fa59c928f8f94a2c320f53144c36d632a140e74c`; Task 228's exact hash must be backfilled by Task 229 through the post-commit context-delta workflow. Current task order is authoritative in `225-348-official-roadmap.md`. The original architect dossier is used only for reconstructed historical work packages and direct rationale strongest through Task 212.
...
| 228 | External Order Intake And Production Demand Architecture | **Complete.** Suggested commit title: `Define order intake and demand architecture`. Exact commit hash: **To be backfilled by Task 229 through the post-commit context-delta workflow.** | None | Selects provider-neutral source evidence, versioned interpretations/contributions, live/reviewed/frozen demand, deltas, adjustments and source-to-plan traceability. |
| 229-348 | Official approved roadmap direction | **Approved sequencing, not implemented by Task 228** | Per task | Task 229 is next; see `225-348-official-roadmap.md`. Later changes require explicit Luke approval. |
...
| 228 | External Order Intake And Production Demand Architecture | Complete; suggested commit `Define order intake and demand architecture`; exact hash to be backfilled by Task 229 | [`228-external-order-intake-production-demand-architecture.md`](./228-external-order-intake-production-demand-architecture.md) | Selects provider-neutral source/order evidence, versioned interpretation, controlled demand lifecycles and source-to-plan traceability without schema/runtime. |
