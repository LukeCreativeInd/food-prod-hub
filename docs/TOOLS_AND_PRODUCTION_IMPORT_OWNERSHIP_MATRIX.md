...
| Formula/component cycle detection | Proposed dependency graph | Tools review; Products/Production canonical views later | Production Data Import evidence; final canonical owner deferred by Task 239 | Future domain validator | Production import reviewer | Production Data Import | Safe blocker category | Retained validation evidence | 239-243 |
...
| Formulas / recipes | Approved source or manual maintenance | Products and/or Production, pending Task 239 | Exact boundary deferred to Task 239 | Owning-domain boundary chosen by Task 239 | Owning-domain reviewer | Owning domain plus import lineage | Redacted readiness only | Permanent canonical | 239, 243 |
| Production methods | Approved production knowledge | Production | Production | Future Production method boundary | Production reviewer | Production plus import lineage | No unrestricted method content | Permanent canonical | 239, 244-245 |
| Work instructions | Approved production knowledge | Production | Production | Future Production instruction boundary | Production reviewer | Production plus import lineage | No unrestricted instruction content | Permanent canonical | 239, 244-245 |
...
| Formula/recipe boundary | Deferred to Task 239. |
