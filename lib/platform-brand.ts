export const PLATFORM_BRAND_NAME = "EveryBatch";
export const PLATFORM_BRAND_CATEGORY = "Food Manufacturing OS";
export const PLATFORM_APP_NAME = PLATFORM_BRAND_NAME;
export const PLATFORM_PRODUCT_LINE = PLATFORM_BRAND_CATEGORY;
export const PLATFORM_OPERATOR_CONSOLE_LABEL =
  "EveryBatch Operator Console";
export const PLATFORM_BRAND_TAGLINE =
...
export const PLATFORM_CENTRAL_APP_DOMAIN = PLATFORM_APP_DOMAIN;
...
export const PLATFORM_BRAND_DESCRIPTION =
  "Food Manufacturing OS for recipes, production, inventory, purchasing, QA and traceability.";

export const PLATFORM_BRAND_PALETTE = {
  deepGreen: "#0F2E23",
  primaryGreen: "#176B3D",
  lime: "#8CC63F",
  softGreen: "#E8F5E9",
