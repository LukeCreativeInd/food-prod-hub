...
The active sequence is [EveryBatch Official Roadmap - Tasks 225-348](./225-348-official-roadmap.md). Task 232 is the latest committed task at `4922b125232720902080e2827665f71b67b46244`; Task 233 remains uncommitted and in correction/review. Review Gate 0 is closed and Architecture Gate 1 is approved. Migration `045_facility_schema_foundation.sql` is live and browser validated but unregistered; Migration 046 is live/registered as `20260804115803 commerce_connection_order_intake_foundation`; Migration 047 is live/registered as `20260804142108 shopify_connector_foundation`; corrective Migration 048 is created but unapplied. Task 233 adds the non-live official Shopify connector foundation without app registration, store installation, live order import, mappings or Production Demand. Task 234 follows only after Migration 048 application/verification, Task 233 commit and development-store validation. Earlier roadmap files are preserved as superseded historical planning.
