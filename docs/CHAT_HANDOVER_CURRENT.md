...
- Latest completed task after the current changeset is committed: **228 - External Order Intake And Production Demand Architecture**
...
- Task 228 suggested commit title: `Define order intake and demand architecture`; exact hash to be backfilled by Task 229 through the post-commit context-delta workflow
- Official roadmap: `docs/225-348-official-roadmap.md`
- Review Gate 0: **closed through Luke's Task 225 approval**
- Next approved task: **229 - Shopify App Architecture and Security Plan**
...
- Tasks 229-230 still own Shopify security/mechanics and calendar/routing detail before Architecture Gate 1.
...
13. The Task 225 approval record, then the Task 224 audit/evidence package where production rationale is needed
14. `history/ORIGINAL_ARCHITECT_MEMORY_DOSSIER.md` only for deeper historical rationale
