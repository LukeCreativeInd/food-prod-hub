...
Task 232 is the latest committed task at `4922b125232720902080e2827665f71b67b46244`; Task 233 remains uncommitted and in correction/review. Architecture Gate 1 is approved. Migration `045_facility_schema_foundation.sql` is live and browser validated but unregistered; Migration 046 is live/registered; Migration 047 is live/registered as `20260804142108 shopify_connector_foundation`; corrective Migration 048 is created/unapplied. Task 234 is next only after Migration 048 application/verification, Task 233 commit and Shopify development-store validation.
...
**Architecture Gate 1 is approved.** Task 231 is committed and Migration 045 is live/browser validated. Task 232 is committed and Migration 046 is live/registered. Task 233 remains in correction/review: Migration 047 is live/registered, Migration 048 is unapplied, and no Shopify app/store is connected.
...
| 233 | Shopify Connector Foundation v1 | **In correction/review; not ready to commit.** Adds official Shopify auth/GraphQL/webhook/worker boundaries, encrypted credential persistence, Tenant Admin readiness and tests. Migration 047 is live/registered; Migration 048 is created/unapplied; app registration, scheduled execution and store validation remain blocked manual steps. | Integration | Yes, `047` live/registered and `048` created/unapplied | Establishes the reviewed non-live connector foundation for replacing manual extraction after the regex repair is applied and verified. |
