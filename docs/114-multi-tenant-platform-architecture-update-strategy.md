...
- Long term, it should separate to `admin.everybatchmrp.com`.
...
Preferred Platform Admin host is now `admin.everybatchmrp.com`. `platform.everybatchmrp.com` is still recognised as a legacy/optional Platform Admin host for compatibility.
