...
The active sequence is [EveryBatch Official Roadmap - Tasks 225-348](./225-348-official-roadmap.md). Task 233 is the latest committed task at `ebe3330514a160cd1820bd35ed804abd85d4e316`; its production correction remains uncommitted and undeployed. Review Gate 0 is closed and Architecture Gate 1 is approved. Migration `045_facility_schema_foundation.sql` is live and browser validated but unregistered; Migration 046 is live/registered as `20260804115803 commerce_connection_order_intake_foundation`; Migration 047 is live/registered as `20260804142108 shopify_connector_foundation`; Migration 048 is live/registered as `20260804145903 shopify_domain_regex_fix`. Task 233 adds the non-live official Shopify connector foundation without app registration, store installation, live order import, mappings or Production Demand. Its correction fixes the deployed Integrations facility-column mismatch and tenant `/shopify` host admission; Task 234 follows only after successful post-correction browser validation and later controlled development-store validation. Earlier roadmap files are preserved as superseded historical planning.
