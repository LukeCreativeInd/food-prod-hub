...
| Cross-module / Delivery and production calendars | No runtime route | Architecture decision complete; not operational | Organisation-owned exact-postcode zones, separate customer service/carrier truth, immutable effective calendars and versioned production-date/facility assignment | No zone/postcode/calendar/parser/engine schema or UI; Task 235 remains later |
| Tenant Admin / Commerce Integrations | `/integrations` | Real Shopify readiness/list view plus truthful future catalogue cards | Migrations 046 and 047 are live; Task 233 adds claim and manufacturer-acceptance actions, discovered-catalogue/run summaries and restricted connector runtime | Corrective Migration 048 unapplied; no registered/connected app, live data, mapping or Production Demand; install/sync actions stay gated |
...
| Production / Demand intake | None | Source schema live; demand missing | Migration 046 preserves connection/order/line attribution; Task 233 can populate privacy-minimised source projections after validation | No live source data, mapping, contribution, demand, freeze or plan linkage; legacy Shopify/Zapiet/CSV flow remains operational |
| Commerce / Shopify connector | `/shopify`, `/api/integrations/shopify/*` | Non-live implementation foundation | Official auth/GraphQL/HMAC runtime, encrypted credential boundary, durable jobs, reconciliation and live/registered Migration 047 | Migration 048 unapplied; no app registration/listing/review/store validation, scheduler, connection, source order or protected customer data exists |
