...
- Current task: **238 - Tools Module Review and Production Import Ownership**; documentation/planning only and uncommitted pending Luke review
- Next task after Task 238 review and commit: **239 - Formula, Method, Work Instruction and Recipes Ownership Decision**
...
- Task 238 selects a dedicated tenant-owned Production Data Import domain governed by Production and surfaced through Tools. Tools is a permanent mixed utility module, not the owner of canonical Products or Production records. No Production import implementation, staging schema, parser, bucket, permission or Migration 056 exists.
